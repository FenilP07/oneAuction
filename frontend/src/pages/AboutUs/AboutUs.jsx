			...
			<section className="container-fluid bgSecond">
				...
				<div className="row px-5">
					...
					<div className="col-12 col-md-6">
						<div className='border border-3 border-secondary rounded-4 p-4'>
							<div className="text-center mb-3">
								<img src="/images/MaxFyreLogo.png" className="img-fluid" alt="MaxFyare Technologies" />
							</div>
							<blockquote class="blockquote">
								<p className="">
				...
				<div className="row bgOne mt-5">
					...
					<div className="col-12 p-5">
						<h2 className="text-center textOne mb-4"><FontAwesomeIcon className='me-2' icon={faGavel} />Our Purpose</h2>
				...
				<div className="row bgSecond p-5">
					...
					<div className="col-12">
						<h2 className="text-center textSecond mb-5"><FontAwesomeIcon className='me-2' icon={faGavel} />How It Is Useful</h2>
