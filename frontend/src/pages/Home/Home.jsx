        ...
        <>
            ...
            <main className="home-page">
                ...
                <section className="browse-auctions-section container-fluid p-5 bgOne">
                    <h2 className="text-center fw-bold textOne mb-5">Browse Auctions</h2>
                ...
                <section className="how-it-works-section container-fluid py-5 bg-light">
                    <h2 className="text-center fw-bold textSecond mb-5">How It Works</h2>
                    {/* For Users */}
                ...
                <section className="unique-section container-fluid bgOne p-5">
                    <h2 className="text-center textOne fw-bold mb-5">What Makes OneAuction Unique</h2>
